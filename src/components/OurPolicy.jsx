    ...
    return (
        <div className="flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700">
            ...
            <div>
                ...
                <p className="text-black">We offer hassle free exchange policy</p> {/* Description of the policy */}
            </div>
            ...
            <div>
                ...
                <p className="text-black">We provide 7 days free return policy</p> {/* Description of the policy */}
            </div>
            ...
            <div>
                ...
                <p className="text-black">We offer 24/7 Customer Support</p> {/* Description of the policy */}
            </div>
        </div>
    );
}
